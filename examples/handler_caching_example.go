...
import (
	...
	"github.com/xihale/syndi/internal/handlercache"
...
func registerCachedRoute(engine *gin.Engine, routePath string, routeHandler func(*ctxpkg.Context) (*models.Feed, error), cacheInstance rsshubcache.Cache) {
	...
	cachedHandler := handlercache.NewCachedHandler(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
...
func registerCachedRouteWithCustomTTL(engine *gin.Engine, routePath string, routeHandler func(*ctxpkg.Context) (*models.Feed, error), cacheInstance rsshubcache.Cache, ttl time.Duration) {
	cachedHandler := handlercache.NewCachedHandlerWithTTL(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
		ctx := ctxpkg.NewContext(c.Writer, c.Request)
		return routeHandler(ctx)
	}, ttl)
...
func registerCachedRouteWithOptions(engine *gin.Engine, routePath string, routeHandler func(*ctxpkg.Context) (*models.Feed, error), cacheInstance rsshubcache.Cache, opts *handlercache.CachedHandlerOptions) {
	cachedHandler := handlercache.Cached(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
		ctx := ctxpkg.NewContext(c.Writer, c.Request)
		return routeHandler(ctx)
	}, opts)
...
func setupRoutesWithCacheConfigs(engine *gin.Engine, cacheInstance rsshubcache.Cache, routeRegistry interface{}) {
	...
	engine.GET("/news/:category", handlercache.NewCachedHandlerWithTTL(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
		// Handler implementation
		return &models.Feed{Title: "News"}, nil
	}, 5*time.Minute))

	// Documentation route with long cache
	engine.GET("/docs/:page", handlercache.NewCachedHandlerWithTTL(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
	...
	engine.GET("/user/:id/feed", handlercache.Cached(cacheInstance, func(c *gin.Context) (*models.Feed, error) {
