...
var zhihuHotRoute = routeutils.RouteSpec{
	...
	Description: "知乎全站热榜（匿名可用；配置 ZHIHU_COOKIES 可获得完整摘要）",
...
var zhihuDailySectionRoute = routeutils.RouteSpec{
	...
	Maintainers: []string{"xihale"},
	Description: "知乎日报主题合集（合集 id 见 https://news-at.zhihu.com/api/7/sections）",
	Categories:  []models.Category{{Name: "new-media"}},
	Parameters: []models.Parameter{
		routeutils.RequiredParam("sectionId", "合集 id"),
