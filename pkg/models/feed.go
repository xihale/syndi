...
type Features struct {
	...
	// EnvDeps lists environment variables (cookies, tokens) this route
	// depends on. Docs frontend grays the route out while any is unset.
	EnvDeps []string `json:"envDeps,omitempty"`
}
